<?php
    ...
    // jika tidak login dan tidak ada password login
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">PBL PNB<sup>2</sup></div>
            </a>
            ...
            <!-- Nav Item -->
            <li class="nav-item">
                <a class="nav-link" href="views/dosen.php">
            ...
            <!-- Nav Item -->
            <li class="nav-item">
                <a class="nav-link" href="CRUD_Matkul/listmatkul1.php">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="logout.php">
                        <input class="btn btn-primary" type="submit" name="tbsubmit" value="LOGOUT">
                    </form>
                </div>
            </div>
        </div>
